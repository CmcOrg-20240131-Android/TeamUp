...
public class HomeChatSessionContentRecycleAdapter extends RecyclerView.Adapter<HomeChatSessionContentRecycleAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        // 创建自定义布局
        View itemView = View.inflate(context, R.layout.home_chat_session_content_item, null);
